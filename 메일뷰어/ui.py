...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table.setGeometry(QRect(0, 10, 581, 371))
        self.lb_title = QLabel(self.centralwidget)
        self.lb_title.setObjectName(u"lb_title")
        self.lb_title.setGeometry(QRect(589, 10, 81, 20))
        self.lb_content = QLabel(self.centralwidget)
        self.lb_content.setObjectName(u"lb_content")
        self.lb_content.setGeometry(QRect(590, 30, 191, 341))
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\ub0a0\uc9dc", None));
